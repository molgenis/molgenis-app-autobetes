...
##### BEFORE #####
touch $PBS_O_WORKDIR/s01_BwaAlignLeft_1.out
source $WORKDIR/tools/scripts/import.sh
before="$(date +%s)"
echo "Begin job s01_BwaAlignLeft_1 at $(date)" >> $PBS_O_WORKDIR/RUNTIME.log
...
-t 4 \
-f $WORKDIR/tmp//demo/output//120308_SN163_0457_BD0E5CACXX_L4_CAACCT_1.bwa_align.human_g1k_v37.sai


putFile $WORKDIR/tmp//demo/output//120308_SN163_0457_BD0E5CACXX_L4_CAACCT_1.bwa_align.human_g1k_v37.sai

###### AFTER ######
after="$(date +%s)"
elapsed_seconds="$(expr $after - $before)"
echo Completed s01_BwaAlignLeft_1 at $(date) in $elapsed_seconds seconds >> $PBS_O_WORKDIR/RUNTIME.log
touch $PBS_O_WORKDIR/s01_BwaAlignLeft_1.finished
######## END ########
