...
//import org.molgenis.autobetes.autobetes.Basal;
//import org.molgenis.autobetes.autobetes.BasalProgrammed;
//import org.molgenis.autobetes.autobetes.BasalSetting;
//import org.molgenis.autobetes.autobetes.BasalTemp;
//import org.molgenis.autobetes.autobetes.Bgsensor;
//import org.molgenis.autobetes.autobetes.Bolus;
//import org.molgenis.autobetes.autobetes.Carbs;
//import org.molgenis.autobetes.autobetes.Exercise;
//import org.molgenis.autobetes.autobetes.Identification;
...
//	}
//
//	private static void loadCarb(List<Carbs> lstFromFile, MapEntity tuple)
//	{
...
//	}
//
//	private static Double getRawDouble(MapEntity tuple, String type)
//	{
...
//				System.err.println(">> MapEntity: " + tuple);
//				System.err.println(">> System exit with status 1.");
//				System.exit(1);
//			}
//		}
...
//	}
//
//	private static Integer getRawInt(MapEntity tuple, String type)
//	{
//		String rawvalues = tuple.getString(RAWVALUES);
//
//		// Possible weakness: we should seek for something ending on ", "!
...
//	}
//
//	private static String getRawString(MapEntity tuple, String type)
//	{
//		String rawvalues = tuple.getString(RAWVALUES);
//
...
//	}
//
//	// private static Double getRawInputBolus(MapEntity tuple)
//	// {
...
//	// }
//
//	private static void loadBolus(List<Bolus> bolusListFile, MapEntity tuple)
//	{
...
//	}
//
//	private static void loadBasal(List<BasalProgrammed> basalListFile, MapEntity tuple)
//	{
...
//	}
//
//	private static void loadBasalTemp(List<BasalTemp> basalTempListFile, MapEntity tuple)
//	{
...
//	}
//
//	private static void loadExercise(List<Exercise> exerciseListFile, MapEntity tuple)
//	{
...
//	}
//
//	private static void loadBgsensor(List<Bgsensor> lstFromFile, MapEntity tuple)
//	{
...
//	}
//
//	private static void setDateTime(Identification e, MapEntity tuple)
//	{
