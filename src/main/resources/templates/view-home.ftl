...
<div class="container" style="margin-top: 20px;">
	<form id="upload-file-form" method="post" action="${context_url}/uploadCSV" enctype="multipart/form-data" onsubmit="parent.showSpinner(function(){$('.modal-body').html('Work in progress..');});  return true;">
	    <div class="row">
